# Shamelessly adopted from the xmpp4r Rakefil
require 'rake'
require "rake/clean"
...
$:.unshift 'lib'
require "configbot/confighandler.rb"
...
Rake::TestTask.new do |t|
  t.libs << "test"
  t.test_files = ['test/ts_configbot.rb']
end
...
# task :update_website do
  # sh %{cp website/* ~/dev/configbot/website/ && cd ~/dev/xmpp4r/website/ && svn commit -m "website update"}
# end
...
###
  ...
  be auto-updated in the 'configbot.gemspec' when you run any
